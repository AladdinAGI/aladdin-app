export const toolsInfo = [
  {
    ...
    examples: {
      en: [
        ...
        'Ethereum market cap',
        'Search by contract address (e.g. 0x...)',
      ],
  ...
  },
  {
    ...
    examples: {
      en: [
        'I have 100 USDT and want to achieve a 5% return target by taking a certain degree of risk. My risk tolerance is 15%.',
      ],
      zh: [
